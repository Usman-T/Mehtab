  ...
  return (
    <div className="flex h-16 w-screen items-center justify-between border-b bg-white px-4">
      <div
        ...
        onClick={() => navigate("/")}
      >
        <LightbulbIcon className="hidden h-6 w-6 text-secondary-foreground lg:block" />
      ...
      <div className="hidden w-full max-w-sm items-center space-x-2 rounded-md border md:flex">
        <Input
          type="text"
